...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MolyPay Money Life — Plataforma de pagos para empresas" },
      { name: "description", content: "Billetera virtual B2B para empresas, consorcios y administradores de alquileres en Argentina." },
      { name: "author", content: "Molly Money Life" },
      { property: "og:title", content: "MolyPay Money Life — Plataforma de pagos para empresas" },
      { property: "og:description", content: "Billetera virtual B2B para empresas, consorcios y administradores de alquileres en Argentina." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,680&family=IBM+Plex+Mono:wght@400;500&display=swap" },
    ],
  }),
